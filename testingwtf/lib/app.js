...
Abba.InputsView = function($form, historyIframe) {
    ...
    this.smallest = new Abba.TextInputView($form.find('.smallest'));
}
...
Abba.Presenter.prototype = {
   ...
   _readSmallestDifference: function() {
      return parseFloat(this._inputsView.smallest.getValue());
   },
    ...
    _parseOption: function(name, valueString) {
        switch(name) {
            ...
            case 'useMultipleTestCorrection':
                ...
                break;
  	    case 'smallest':
	        this._inputsView.smallest.setValue(valueString)
                break;
        }
    },
    ...
    _renderResults: function(state) {
        ...
        test.setSmallestDifference(this._inputsView.smallest.getValue());
    ...
    _handleHistoryChange: function(hash) {
        ...
        if (hash) {
  	    ...
  	    this._inputsView.smallest.setValue(10);
